...
public class CuttingQueueWaitFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        queueView = inflater.inflate(R.layout.fragment_cutting_queue_wait, container, false);

        queueView = inflater.inflate(R.layout.fragment_farmer_process, container, false);
        ...
        String url = getString(R.string.web_app_url) + "QueueCutter.php?USERNAME=" + USERNAME
